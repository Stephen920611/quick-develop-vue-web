 ...
 * @param data
 */
export function uploadImageBase64(data) {
    return request({
 ...
 * @param data
 */
export function saveVideoManualCapture(data) {
    return request({
        url: '/videoManualCapture/saveOrUpdate',
        method: 'post',
        data
    })
}
 ...
 *
 */
export function videoManualCaptureByPage(data) {
    return request({
        // url: '/videoManualCapture/page',
 ...
 * @param data
 */
export function delVideoManualCapture(data) {
    return request({
        url: '/videoManualCapture/delete',
        method: 'post',
        data
    })
}
 ...
 * @param data
 */
export function getVideoManualCapture(data) {
    return request({
        url: '/videoManualCapture/get',
        method: 'post',
        data
    })
}