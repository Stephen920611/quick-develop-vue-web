        ...
        <div class="mask-content" id="mask-content">
            <div  class="mask-content-des-all" >
                ...
                <el-table
                        ...
                        height="450px"
                >
                    <el-table-column label="告警名称" type="index" align="center" width="220">
                        <template slot-scope="{row}">{{row.name}}</template>
                    </el-table-column>
                    <el-table-column label="告警地点" header-align="center" align="center">
                        <template slot-scope="{row}">{{row.address}}</template>
                    </el-table-column>
                    <el-table-column label="告警时间" header-align="center" align="center">
...
<script>
    ...
    import {fetchAlarmList} from '@/api/task'
