...
import commandDispatchRouter from './modules/commandDispatch'
import searchRouter from './modules/search'
import environmentManageRouter from './modules/environmentManage'
...
export const asyncRoutes = [
  ...
  /** -------------------------------- 指挥调度 --------------------------------**/
  // commandDispatchRouter,

  /** -------------------------------- 环境管理 --------------------------------**/
  environmentManageRouter,
