<template>
    ...
    <div :class="classObj" class="app-wrapper">
        <div v-if="device==='mobile'&&sidebar.opened" class="drawer-bg" @click="handleClickOutside"/>
        <head-navbar ref="headNavBar"/>
        <sidebar v-if="hasSidebar" id="sidebar" class="sidebar-container" style="padding-top: 60px"/>
        ...
        <div id="main-container" v-scrollBar :class="['main-container', !hasSidebar ? 'mg-no-sideBar-width' : 'mg-sideBar-width']" >
            <app-main/>
