<template>
    <div :class="{'has-logo':showLogo}" class="head-nav-bar">
        ...
        <!-- ****************************************** 水平路由 ************************************************ -->
        <div id="headerMenu" class="header-menu" :style="toggleMenuVisible ? null : 'transition: 2s;overflow:hidden'">
            <el-menu
                    ref="subMenuList"
        ...
        <div class="right-menu">
            ...
            <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
                <div class="avatar-wrapper">
                    ...
                    <span class="user-name-wrapper">{{ userInfo.realName ? userInfo.realName : '' }}</span>
        ...
        <el-dialog
                ...
                append-to-body
        >
            <el-form ref="updatePasswordForm" :model="updatePasswordForm" :rules="rules" status-icon>
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button
                        ...
                        @click="submitForm('updatePasswordForm')"
                >确 定
                </el-button>
            </div>
        </el-dialog>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        const params = {
                            newPassword: this.updatePasswordForm.password,
             ...
             */
            async logout() {
                await this.$store.dispatch('user/logout', {'account': this.userInfo.account})
                const {dispatch} = this.$store
                // 关闭显示侧边栏
                dispatch({
                    type: 'app/updateSidebar', // 调用action
